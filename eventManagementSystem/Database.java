...
public class Database {
    ...
    public static void initializeData() {
        ...
        // to create category objects and add them to the categories lists
        ...
        // to create room objects and add them to the rooms list
        ...
        // Create organizer objects first, as we need them for the events
        ...
        // to create an event objects and add them to the events list
        ...
        // Admin
        Admin admin1 = new Admin("hassan", "Hassanmoussa1", "2000-02-26");
        admins.add(admin1);


        // to create an attendee objects and add them to the attendees list
    ...
    public static void loadData() {
        try (ObjectInputStream in = new ObjectInputStream(new FileInputStream("users.dat"))) {
            ...
            System.out.println("Data loaded successfully. Total users: " + users.size());
        } catch (IOException | ClassNotFoundException e) {
            // If file does not exist or an error occurs, users will remain empty
            System.out.println("No data found or an error occurred while loading.");
        }
    }
